...
import RegistrationFormRedesigned from './RegistrationFormRedesigned'

export default {
  title: 'features/RegistrationForm/redesigned',
  component: RegistrationFormRedesigned,
  argTypes: {
...
} as Meta<typeof RegistrationFormRedesigned>

type Story = StoryObj<typeof RegistrationFormRedesigned>
